...
### 📑 Project Index
* **Coral Yoshinaga** — A media site focusing on art and lifestyle visuals.
* **KamataOrchestra** — Exploring the intersection of local culture and sound.
* **v-BiS** — A curated gallery site for visual inspiration.
* **Socho Notebook!** — Official website for my band project.
